        ...
        <div className="containerHome container xl mx-auto h-full pt-28 relative block laptop:flex" >
            <div className="containerLeft w-full laptop:w-1/2 h-full mobile:py-5 smallMobile:py-5 flex items-center rounded relative">
                ...
                <div className="text-box absolute top-[60%] bigMobile:top-[50%] mobile:top-[30%] smallMobile:top-[20%] w-[95%] ">
                    <h1 className="text-9xl tablet:text-8xl bigMobile:text-6xl mobile:text-4xl smallMobile:text-2xl leading-[140px] tablet:leading-[140px] bigMobile:leading-[100px] mobile:leading-[90px] smallMobile:leading-[70px]">Buy & exchange </h1>
            ...
            <div className="containerRight w-full laptop:w-1/2 h-full mobile:h-auto smallMobile:h-auto mobile:py-5 smallMobile:py-5 flex items-center justify-center">
                <div className="boxBuy w-[95%] bigMobile:w-[85%] tablet:w-[80%] h-auto p-3">
                    <div className="boxBuyHeader border-b p-3 ">
                        <div className="rounded-xl bg-sky-600 w-32 h-24 flex items-center justify-center"><img src={logo280px} alt="logo" className="w-28 h-16" /></div>
                    </div>
                    <div className="boxBuyBody py-5">
                        <div className="boxTime my-3 w-full p-3 rounded-xl bg-white h-auto block mobile:flex mobile:justify-between">
                        ...
                        <div className="boxDisplayBody my-3 w-full p-3 rounded-xl bg-white h-auto block  mobile:justify-between mobile:flex">
                            <div className="p-2">
